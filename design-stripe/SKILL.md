---
name: design-stripe
description: Apply Stripe's design system (colors, typography, components, layout, shadows) when building UI. Use when the user wants to create interfaces styled like Stripe.
---

# Stripe Design System Skill
