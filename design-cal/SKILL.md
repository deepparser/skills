---
name: design-cal
description: Apply Cal.com's design system (colors, typography, components, layout, shadows) when building UI. Use when the user wants to create interfaces styled like Cal.com.
---
