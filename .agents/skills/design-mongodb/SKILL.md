---
name: design-mongodb
description: Apply MongoDB's design system (colors, typography, components, layout, shadows) when building UI. Use when the user wants to create interfaces styled like MongoDB.
---
